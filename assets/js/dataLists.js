module.exports = {
    ...
    'locomotion_list_ps': ['Number of steps_ps', 'Frail Score_ps', 'Sarcopenia Score_ps', 'Walked distance_ps'],
    'sensory_list_ps': ['Sensory_conditions_ps'],
    'psychological_list_ps': ['Sleep Duration_ps', 'Light Sleep Duration_ps', 'Deep Sleep Duration_ps', 'PHQ9 Score_ps', 'GDS Score_ps', 'Psychological_conditions_ps'],
    'cognition_list_ps': ['MOCA Score_ps', 'RCS Score_ps', 'Cognition_conditions_ps'],
    'vitality_list_ps': ['MNA Score_ps', 'SNAQ Score_ps', 'Average Heart Rate_ps', 'Max Heart Rate_ps', 'Min Heart Rate_ps',
    ...
    'locomotion_list_imputed': ['Number of steps_imputed', 'Frail Score_imputed', 'Sarcopenia Score_imputed', 'Walked distance_imputed'],
    'sensory_list_imputed': ['Sensory_conditions_imputed'],
    'psychological_list_imputed': ['Sleep Duration_imputed', 'Light Sleep Duration_imputed', 'Deep Sleep Duration_imputed', 'PHQ9 Score_imputed', 'GDS Score_imputed', 'imputedychological_conditions_imputed'],
    'cognition_list_imputed': ['MOCA Score_imputed', 'RCS Score_imputed', 'Cognition_conditions_imputed'],
    'vitality_list_imputed': ['MNA Score_imputed', 'SNAQ Score_imputed', 'Average Heart Rate_imputed', 'Max Heart Rate_imputed', 'Min Heart Rate_imputed',
